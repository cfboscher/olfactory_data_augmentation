...
def get_lexifield_terms(config):
    if config.dataset in ['odeuropa', 'coco_olf', 'coco_gus', "gpt4_olf"]:
        path = 'code/step_2/lexifield/olf.json'

    elif config.dataset in ['auditory', 'coco_aud']:
        path = 'code/step_2/lexifield/sound.json'
