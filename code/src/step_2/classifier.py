...
def build_model(config):
    ...
    config = RobertaConfig.from_pretrained('code/step_2/roberta-base/config-roberta-base.json')
    bert_model = TFRobertaModel.from_pretrained('code/step_2/roberta-base/roberta-base.h5', config=config)
