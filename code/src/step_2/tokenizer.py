...
def load_tokenizer():
    ...
    tokenizer = tokenizers.ByteLevelBPETokenizer(vocab='code/step_2/roberta-base/vocab-roberta-base.json',
                                                 merges='code/step_2/roberta-base/merges-roberta-base.txt',
                                                 lowercase=True,
...
def tokenize_test_data(tokenizer, test_data, sensoriality_id, config):
    ...
    for k in range(test_data.shape[0]):
        ...
        test_data['clean_sentence'] = test_data['clean_sentence'].apply(lambda x: str(x))
